...
class fmRadioFlowGraph(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fmRadioFlowGraph")
        ...
        self.channel_freq = channel_freq = 98.1e6
...
def main(top_block_cls=fmRadioFlowGraph, options=None):
